...
import FeatureColorMap from '../lib/FeatureColorMap.js'
...
import GenomeView      from './GenomeView.vue'
import HelpBox         from './HelpBox.vue'
import ListEditor      from './ListEditor.vue'
import MComponent      from './MComponent.js'
import MFooter         from './MFooter.vue'
import MHeader         from './MHeader.vue'
import MyLists         from './MyLists.vue'
import PageBox         from './PageBox.vue'
import PageBoxContainer from './PageBoxContainer.vue'
import Settings        from './Settings.vue'
import SequenceCart    from './SequenceCart.vue'
...
import PreferencesManager from '../lib/PreferencesManager.js'
import RegionManager   from '../lib/RegionManager.js'
//
